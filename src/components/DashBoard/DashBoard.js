                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <div className="d-flex flex-row justify-content-end">
                      <span className="mr-2">
                        <i className="fa fa-square text-primary" /> This Week
                      </span>
                      <span>
                        <i className="fa fa-square text-gray" /> Last Week
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    <div className="d-flex">
                      ...
                      <p className="ml-auto d-flex flex-column text-right">
                        <span className="text-success">
                          <i className="fa fa-arrow-up" /> 33.1%
                        </span>
                    ...
                    <div className="d-flex flex-row justify-content-end">
                      <span className="mr-2">
                        <i className="fa fa-square text-primary" /> This year
                      </span>
                      <span>
                        <i className="fa fa-square text-gray" /> Last year
                      </span>
                    </div>
                  </div>
                </div>
